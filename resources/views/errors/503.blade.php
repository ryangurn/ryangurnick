            ...
            <main class="sm:flex">
                ...
                <div class="sm:ml-6">
                    <div class="sm:border-l sm:border-gray-200 sm:pl-6">
                        <h1 class="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">Maintenance taking place</h1>
                        <p class="mt-1 text-base text-gray-500">sorry for the inconvenience, awesome changes are in progress.</p>
                        <p class="mt-2 text-xs text-gray-500">administrators can log in below to manage the site.</p>
                    </div>
