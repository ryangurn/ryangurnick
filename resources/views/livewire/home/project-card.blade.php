<x-card :pm="$page_module">
    ...
    <x-slot name="body">
        ...
        <livewire:core.card-footer :page_module="$page_module" :duration="$updated_at" modal="home.edit-project" :modal_parameters="['projects' => $projects, 'page_module' => $page_module]" />
