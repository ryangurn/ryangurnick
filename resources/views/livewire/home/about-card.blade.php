<x-card :pm="$page_module">
    ...
    <x-slot name="body">
        ...
        <livewire:core.card-footer :page_module="$page_module" :duration="$updated_at" modal="home.edit.edit-about" :modal_parameters="['name' => $name, 'body' => $body, 'page_module' => $page_module]" />
