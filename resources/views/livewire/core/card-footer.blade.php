<div class="flex items-center justify-between mt-6">
    ...
    <div class="flex items-center space-x-2" x-init="$wire.show">
        ...
        <button wire:click="$toggle('show')" x-data="{ hide(){ $wire.hidePopup() }, show() { $wire.showPopup() } }" x-on:click.away="hide()" x-on:mouseover="show()" x-on:mouseleave="hide()" class="relative bg-gray-100 hover:bg-gray-200 rounded-full h-7 transition duration-150 ease-in py-2 px-3">
