<x-card :pm="$page_module">
    ...
    <x-slot name="body">
        ...
        <livewire:core.card-footer :page_module="$page_module" :duration="$updated_at" modal="resume.edit.edit-computer-science-experience" :modal_parameters="['roles' => $roles, 'page_module' => $page_module]" />
    </x-slot>
</x-card>
