<div x-data>
    <div class="pt-2 border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm overflow-hidden focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500">
        ...
        <textarea rows="10" name="card body" id="card body" class="block dark:text-gray-400 dark:bg-gray-900 dark:placeholder-gray-300 w-full border-0 py-0 p-3 placeholder-gray-500 focus:ring-0 sm:text-sm" placeholder="Write a body..." wire:model="body"></textarea>
