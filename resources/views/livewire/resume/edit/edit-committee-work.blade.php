            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-5">
                    <fieldset class="bg-white dark:bg-gray-900">
                        <legend class="block text-sm font-medium text-gray-700 dark:text-gray-400">Billing address</legend>
                        <div class="mt-1 rounded-md shadow-sm -space-y-px">
                            ...
                            <div>
                                ...
                                <input type="text" class="dark:border-gray-700 dark:text-gray-400 dark:bg-gray-900 dark:placeholder-gray-300 focus:ring-indigo-500 focus:border-indigo-500 relative block w-full rounded-none bg-transparent focus:z-10 sm:text-sm border-gray-300" placeholder="location #{{ $key+1 }}" wire:model="institutions.{{ $key }}.location">
                            </div>
                            <div>
                                <label class="sr-only dark:text-gray-400">organization #{{ $key+1 }}</label>
                                <input type="text" class="dark:border-gray-700 dark:text-gray-400 dark:bg-gray-900 dark:placeholder-gray-300 focus:ring-indigo-500 focus:border-indigo-500 relative block w-full rounded-none bg-transparent focus:z-10 sm:text-sm border-gray-300" placeholder="organization #{{ $key+1 }}" wire:model="institutions.{{ $key }}.organization">
                            </div>
                            <div>
                                <label class="sr-only dark:text-gray-400">position #{{ $key+1 }}</label>
                                <input type="text" class="dark:border-gray-700 dark:text-gray-400 dark:bg-gray-900 dark:placeholder-gray-300 focus:ring-indigo-500 focus:border-indigo-500 relative block w-full rounded-none rounded-b-md bg-transparent focus:z-10 sm:text-sm border-gray-300" placeholder="position #{{ $key+1 }}" wire:model="institutions.{{ $key }}.position">
                            </div>
                        </div>
                    </fieldset>
                </div>
