                    ...
                    <fieldset class="bg-white dark:bg-gray-900">
                        ...
                        <div class="mt-1 rounded-md shadow-sm -space-y-px">
                            ...
                            <div>
                                ...
                                <textarea class="dark:border-gray-700 dark:text-gray-400 dark:bg-gray-900 dark:placeholder-gray-300 focus:ring-indigo-500 focus:border-indigo-500 relative block w-full p-3 rounded-none rounded-b-md bg-transparent focus:z-10 sm:text-sm border-gray-300" wire:model="roles.{{ $key }}.body" placeholder="description #{{ $key+1 }}"></textarea>
                            </div>
                        </div>
                    </fieldset>
                </div>
