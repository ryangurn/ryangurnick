...
@section('additional_headers')
    <div class="flex mt-2 md:mt-0 items-center gap-4">
        @can('access telescope')
            <a href="/telescope" class="text-sm text-gray-700 dark:text-white border rounded-full p-1 border-black dark:border-white hover:text-gray-300">
        ...
        @auth
            ...
            <a href="#" onclick="Livewire.emit('openModal', 'framework.analytics')" class="text-sm text-gray-700 dark:text-white border rounded-full p-1 border-black dark:border-white hover:text-gray-300">
            ...
            @endcan
            @can('view emails')
            <a href="#" onclick="Livewire.emitTo('framework.email-slideover', 'show')" class="text-sm text-gray-700 dark:text-white border rounded-full p-1 border-black dark:border-white hover:text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <a href="#" onclick="Livewire.emitTo('framework.settings-slideover', 'show')" class="text-sm text-gray-700 dark:text-white border rounded-full p-1 border-black dark:border-white hover:text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <a href="#" onclick="Livewire.emitTo('framework.access-slideover', 'show')" class="text-sm text-gray-700 dark:text-white border rounded-full p-1 border-black dark:border-white hover:text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd" />
                </svg>
            </a>
            <a href="#" onclick="Livewire.emitTo('framework.user-slideover', 'show')" class="text-sm text-gray-700 dark:text-white border rounded-full p-1 border-black dark:border-white hover:text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <a href="#" onclick="Livewire.emitTo('framework.configuration-slideover', 'show')" class="text-sm text-gray-700 dark:text-white border rounded-full p-1 border-black dark:border-white hover:text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        @if (Route::has('login'))
            @auth
                <form method="POST" action="{{ route('logout') }}" class="text-sm text-gray-700 dark:text-white border rounded-full p-1 border-black dark:border-white hover:text-gray-300">
                    @csrf

                    <a href="{{ route('logout') }}" class="text-sm text-gray-700 dark:text-white hover:text-gray-300 underline" onclick="event.preventDefault(); this.closest('form').submit();">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    ...
    <main class="container mx-auto max-w-5xl flex flex-col md:flex-row">
        <div class="w-full">
            <nav class="flex items-center justify-between text-xs">
                <ul class="flex mx-auto md:mx-4 font-semibold border-b-4 dark:border-black pb-3 space-x-10">
                    {{ $menu }}
                </ul>
            </nav>
