            ...
            <div class="flex px-2 py-6 w-full">
                <div class="mx-4 w-full">
                    <div class="text-gray-600 mt-3">
                        <ul class="text-lg ml-4">
                            <li class="pb-4">
                                <a href="#" class="border-b-4 pb-3 border-solid transition duration-150 ease-in border-b-4 pb-3 hover:border-green">
                                    cste
                            ...
                            <li class="pb-4">
                                <a href="#" class="border-b-4 pb-3 border-solid transition duration-150 ease-in border-b-4 pb-3 hover:border-yellow">
                                    regtools
                                    <span class="float-right inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
